...
WRITE/W. Самостоятельные DO/RETURN/WRITE пока дают явную ошибку E13
...
драйвер, не нормативный интерпретатор. Семантика будущих DO/RETURN/WRITE
...
FOCAL QUIT внутри программ и все прежние expected/проверки сохранены.
